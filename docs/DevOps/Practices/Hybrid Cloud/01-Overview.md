...
![meme](./images/overview/image-1.png)
...
![ci-cd-flow](./images/overview/image-2.png)

2. **Pipeline:**

- Jenkins checkout code từ Gitlab
- Build image
- Push image trong Harbor
- Update manifest repo (on-premise folder)
- Thông báo tới telegram để QA biết
- Sau khi QA test xong sẽ nhấn approve
- Push image lên Artifact Registry
- Update manifest repo (cloud folder)

![pipeline](./images/overview/image-3.png)
...
![Failover flow](./images/overview/image-6.png)

---

### 3. Bộ Stack công nghệ "Thực chiến"

Trong series này, chúng ta sẽ không nói lý thuyết suông. Mình sẽ cùng bạn cài đặt và cấu hình "from zero to one":

![tech stack](./images/overview/image-7.png)
